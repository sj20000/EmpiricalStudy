# https://github.com/yongduosui/CAL/blob/main/opts.py

import argparse
from model import CausalGCN, CausalGIN, CausalGAT, GINNet, GCNNet, GATNet, GraphSAGE 
from model import GCNNet_citation,GATNet_citation, GraphSAGE_citation, GINNet_citation
from model import CausalGCN_citation, CausalGAT_citation, CausalGIN_citation
import numpy as np
import random
import torch
from itertools import product

cit=True #for citation datasets
...
def parse_args():
    ...
    parser.add_argument('--folds', type=int, default=5)         ##############FOLDS
    ...
    parser.add_argument('--model', type=str, default="CausalGAT", help="CausalGCN, CausalGIN")
    # parser.add_argument('--model', type=str, default="GAT", help="GCN, GIN")
    # parser.add_argument('--model', type=str, default="GraphSAGE", help="GCN, GIN")
